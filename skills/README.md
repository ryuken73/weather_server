...
| [`weather-image-pipeline`](weather-image-pipeline/SKILL.md) | parse_netcdf 경계, 구름/RDR/GFS/AWS PNG, `sync_image.sh`, IR105 JSON 정리 |
...
- 구름·RDR·GFS·레거시 AWS **이미지**: [`weather-image-pipeline`](weather-image-pipeline/SKILL.md) · [parse_netcdf](https://gitlabsvr.sbs.co.kr/weather_system/parse_netcdf) · [`../docs/pipeline-image-flow-draft.md`](../docs/pipeline-image-flow-draft.md)
