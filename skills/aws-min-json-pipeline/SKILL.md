...
- 요건: `docs/aws-producer-1min-pack-requirements.md`, `docs/rainfall-producer-rn24-rnday-change-request.md`, `docs/rainfall-producer-today-pack-refresh-request.md`
