...
- Builder: `kma_fetch/utils/aws_min_pack.js` (`schemaVersion: 4`, `contractRevision: 5`)
- RN_DAY 주간 역행 → pack missing; RN_24HR은 last accepted로 계산 (`counterRegressionFilledSampleCount`). 재워밍 예: `--from 20260820 --to 20260820 --variables RN_24HR,RN_DAY --force`
