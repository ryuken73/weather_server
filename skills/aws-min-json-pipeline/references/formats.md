...
Hub RN-DAY는 종종 **00:01에 reset**되므로 pack은 당일·전일 **00:00을 0으로 정규화**한 뒤, **날짜 중간 역행은 RN_DAY pack에서 missing**, RN_24HR 계산에는 **직전 accepted 값**을 쓴다 (원천 결측 fill·offset stitching 없음).
